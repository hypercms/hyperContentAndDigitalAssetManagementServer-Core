...
if (!valid_publicationname ($site) || !valid_locationname ($location) || !valid_objectname ($cat) || ($cat == "comp" && $globalpermission[$site]['component'] != 1) || ($cat == "page" && $globalpermission[$site]['page'] != 1)) killsession ($user);

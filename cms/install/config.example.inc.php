...
$mgmt_config['url_path_cms'] = $mgmt_config['url_protocol']."www.yourdomain.net/cms/";
$mgmt_config['abs_path_cms'] = "/web/cms/public_html/cms/";
...
$mgmt_config['url_path_rep'] = $mgmt_config['url_protocol']."www.yourdomain.net/repository/";
$mgmt_config['abs_path_rep'] = "/web/cms/public_html/repository/";
...
$mgmt_config['url_path_data'] = $mgmt_config['url_protocol']."www.yourdomain.net/data/";
$mgmt_config['abs_path_data'] = "/web/cms/public_html/data/";
...
// show (true) or hide (false) information boxes to the user.
...
$mgmt_config['explorer_list_maxitems'] = 100;
...
// ------------------------------------ Executable Linking -------------------------------------
// hyperCMS uses third party PlugIns to parse, convert or uncompress files.
// Please download and install the package of the vendors or your OS distribution:
...
$mgmt_docpreview['.bib.doc.docx.dot.ltx.odd.odt.odg.odp.ods.ppt.pptx.pxl.psw.pts.rtf.sda.sdc.sdd.sdw.sxw.txt.htm.html.xhtml.xls.xlsx'] = "/usr/bin/unoconv";
...
$mgmt_config['dbhost'] = "localhost";
$mgmt_config['dbuser'] = "username";
$mgmt_config['dbpasswd'] = "password";
$mgmt_config['dbname'] = "hypercms";
...
$mgmt_config['smtp_host']     = "mx.yourdomain.net";
$mgmt_config['smtp_username'] = "username";
$mgmt_config['smtp_password'] = "password";
$mgmt_config['smtp_port']     = "25";
$mgmt_config['smtp_sender']   = "sender@yourdomain.net";

...
if ($multiobject != "")
{
  ...
  {
    $pagename = $multiobject_count.$text59[$lang];
  }
...
if (checktoken ($token, $user))
{
  ...
  elseif ($action == "zip" && $setlocalpermission['root'] == 1)
  {
    ...
    if ($result['result'] == true)
    {
      ...
      $show = $text56[$lang].$pagenew.$text57[$lang];
      $page = $result['object'];
      $pagename = $result['name'];
      $filetype = $result['objecttype'];  
    }
    else
    {
      ...
      $show = $text56[$lang].$pagenew.str_replace ("%filesize%", $mgmt_config['maxzipsize'], $text58[$lang]);
    }
  }
}
...
function submitToWindow (url, action, windowname, features, width, height)
{
  ...
  else alert ('<?php echo $text82[$lang]; ?>');
}
...
{
  check = confirm ("<?php echo $text8[$lang]; ?>");
  ...
  {    
    ...
    {
      echo "hcms_openBrWindowItem('popup_action.php?site=".url_encode($site)."&cat=".url_encode($cat)."&action=delete&location=".url_encode($location_esc)."&page=".url_encode($page)."&multiobject=".url_encode($multiobject)."&token=".$token_new."','','scrollbars=no,resizable=no','400','120');\n";
    }
    ?>
  }
}
...
<div class="hcmsToolbar">
  ...
  <div class="hcmsToolbarBlock">
       ...
       )
    {
       ...
       "alt=\"".$text4[$lang]."\" title=\"".$text4[$lang]."\" />\n";
    }
    else
    {
  ...
  <div class="hcmsToolbarBlock">
    ...
    echo "
      ...
      <div onClick=\"switchselector('select_obj_view');\" class=\"hcmsButton hcmsButtonSizeWide\"><img src=\"".getthemelocation()."img/button_view_gallery_".$temp_explorerview.".gif\" style=\"padding:2px; width:18px; height:18px;\" id=\"pic_obj_view\" name=\"pic_obj_view\" alt=\"".$text5[$lang]."\" title=\"".$text5[$lang]."\" /><img src=\"".getthemelocation()."img/pointer_select.gif\" class=\" hcmsButtonSizeNarrow\" alt=\"".$text5[$lang]."\" title=\"".$text5[$lang]."\" /></div>
      <div id=\"select_obj_view\" class=\"hcmsSelector\" style=\"position:absolute; top:5px; left:".$left."; visibility:hidden; z-index:999; max-height:80px; overflow:auto; overflow-x:hidden; overflow-y:auto; white-space:nowrap;\">
        <div class=\"hcmsSelectorItem\" onclick=\"switchview ('large');\"><img src=\"".getthemelocation()."img/button_view_gallery_large.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text70[$lang]."&nbsp;</div>
        <div class=\"hcmsSelectorItem\" onclick=\"switchview ('medium');\"><img src=\"".getthemelocation()."img/button_view_gallery_medium.gif\" style=\"border:0; padding:1px;\" align=\"absmiddle\" />".$text69[$lang]."&nbsp;</div>
        <div class=\"hcmsSelectorItem\" onclick=\"switchview ('small');\"><img src=\"".getthemelocation()."img/button_view_gallery_small.gif\" style=\"border:0; padding:1px;\" align=\"absmiddle\" />".$text68[$lang]."&nbsp;</div>
        <div class=\"hcmsSelectorItem\" onclick=\"switchview ('detail');\"><img src=\"".getthemelocation()."img/button_view_gallery_detail.gif\" style=\"border:0; padding:1px;\" align=\"absmiddle\" />".$text67[$lang]."&nbsp;</div>
      </div>\n";
    ?>
    ...
    {
        echo "
      <img src=\"".getthemelocation()."img/button_sidebar.gif\" class=\"hcmsButton hcmsButtonSizeSquare\" onclick=\"switchsidebar ();\" title=\"".$text90[$lang]."\" alt=\"".$text90[$lang]."\" />\n";
    }
    ?>
    ...
    if (!$is_mobile)
    {
      ...
      {
        echo "
      <img src=\"".getthemelocation()."img/button_filter.gif\" class=\"hcmsButton hcmsButtonSizeSquare\" onclick=\"switchfilter();\" title=\"".$text83[$lang]."\" alt=\"".$text83[$lang]."\" />\n";
      }
      else
      {
        echo "
  ...
  <div class="hcmsToolbarBlock">
       ...
       )
    {
      echo "<img class=\"hcmsButton hcmsButtonSizeSquare\" ".
           "onClick=\"if (locklayer == false) hcms_showHideLayers(".
                                                      ...
                                                      "'zipLayer','','show'".
                                                      ");\" name=\"pic_zip_create\" src=\"".getthemelocation()."img/button_zip.gif\" alt=\"".$text55[$lang]."\" title=\"".$text55[$lang]."\" />\n";
    }
    else
    {
    ...
    {
      echo "<img class=\"hcmsButton hcmsButtonSizeSquare\" ".
           "onClick=\"if (locklayer == false) hcms_openBrWindowItem('popup_action.php?action=unzip&site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&token=".$token_new."','','scrollbars=no,resizable=no','400','120');\" ".
           "name=\"pic_unzip\" src=\"".getthemelocation()."img/button_unzip.gif\" alt=\"".$text44[$lang]."\" title=\"".$text44[$lang]."\" />\n";
    }
    else
    {
  ...
  <div class="hcmsToolbarBlock">
    ...
    if ($multiobject_count <= 1 && $perm_rendering && $lock_rendering && $page != "" && $media != "" && ($doc_rendering || $img_rendering || $dropbox_rendering))
    {
      ...
      if ($doc_rendering)
      {
        ...
        if (!empty ($mgmt_docoptions['.doc']) && in_array('.doc', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('doc');\"><img src=\"".getthemelocation()."img/file_doc.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text73[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.csv']) && in_array('.csv', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('csv');\"><img src=\"".getthemelocation()."img/file_csv.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text74[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.xls']) && in_array('.xls', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('xls');\"><img src=\"".getthemelocation()."img/file_xls.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text75[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.ppt']) && in_array('.ppt', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('ppt');\"><img src=\"".getthemelocation()."img/file_ppt.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text76[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.html']) && in_array('.html', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('html');\"><img src=\"".getthemelocation()."img/file_htm.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text77[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.odt']) && in_array('.odt', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('odt');\"><img src=\"".getthemelocation()."img/file_odt.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text78[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.ods']) && in_array('.ods', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('ods');\"><img src=\"".getthemelocation()."img/file_ods.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text79[$lang]."&nbsp;</div>\n";
        if (!empty ($mgmt_docoptions['.odp']) && in_array('.odp', $mgmt_docconvert[$media_info['ext']])) echo "        <div class=\"hcmsSelectorItem\" onclick=\"docConvert ('odp');\"><img src=\"".getthemelocation()."img/file_odp.gif\" style=\"border:0; margin:0; padding:1px;\" align=\"absmiddle\" />".$text80[$lang]."&nbsp;</div>\n";
      }
    ...
    {
      echo "<div class=\"hcmsButtonOff hcmsButtonSizeWide\"><img src=\"".getthemelocation()."img/button_file_download.gif\" class=\"hcmsButtonSizeSquare\" /><img src=\"".getthemelocation()."img/pointer_select.gif\" class=\"hcmsButtonSizeNarrow\" alt=\"".$text6[$lang]."\" title=\"".$text6[$lang]."\" /></div>\n";
    }
    ...
    {
      if ($page != ".folder") echo "<img onClick=\"hcms_openBrWindowItem('frameset_content.php?site=".url_encode($site)."&ctrlreload=yes&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."','".$container_id."','status=yes,scrollbars=no,resizable=yes','800','600');\"\" class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_edit\" src=\"".getthemelocation()."img/button_file_edit.gif\" alt=\"".$text45[$lang]."\" title=\"".$text45[$lang]."\" />\n";
      elseif ($page == ".folder") echo "<img onClick=\"hcms_openBrWindowItem('frameset_content.php?site=".url_encode($site)."&ctrlreload=yes&cat=".url_encode($cat)."&location=".url_encode($location_esc.$folder)."/&page=".url_encode($page)."','".$container_id."','status=yes,scrollbars=no,resizable=yes','800','600');\"\" class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_edit\" src=\"".getthemelocation()."img/button_file_edit.gif\" alt=\"".$text45[$lang]."\" title=\"".$text45[$lang]."\" />\n";
    }
    // Edit button to edit the fileds which are equal across all selected files
    elseif ($multiobject_count > 1)
    {
      echo "<img onClick=\"submitToWindow('page_multiedit.php','', 'multiedit','status=yes,scrollbars=yes,resizable=yes','800','600');\"\" class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_edit\" src=\"".getthemelocation()."img/button_file_edit.gif\" alt=\"".$text45[$lang]."\" title=\"".$text45[$lang]."\" />\n";
    }
    else 
    {
    ...
    if ($hcms_linking['type'] != "Object" && $from_page == "" && $setlocalpermission['root'] == 1 && $setlocalpermission['foldercreate'] == 1)
    {
      echo "<img class=\"hcmsButton hcmsButtonSizeSquare\" ".
           "onClick=\"if (locklayer == false) hcms_showHideLayers(".
                                                      ...
                                                      "'objrenameLayer','','hide',".
                                                      "'hcms_messageLayer','','hide'".
                                                      ");\" name=\"pic_folder_create\" src=\"".getthemelocation()."img/button_folder_new.gif\" alt=\"".$text14[$lang]."\" title=\"".$text14[$lang]."\" />\n";
    }
    else
    {
  ...
  <div class="hcmsToolbarBlock">
    ...
    {echo "<img class=\"hcmsButton hcmsButtonSizeSquare\" onClick=\"hcms_openBrWindowItem('frameset_content.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."','','status=yes,scrollbars=no,resizable=yes,width=800,height=600','800','600');\" name=\"pic_obj_new\" src=\"".getthemelocation()."img/button_file_new.gif\" alt=\"".$text16[$lang]."\" title=\"".$text16[$lang]."\" />\n";}
    else
    ...
    {echo "<img class=\"hcmsButton hcmsButtonSizeSquare\" onClick=\"hcms_showHideLayers('foldercreateLayer','','hide','folderrenameLayer','','hide','fileuploadLayer','','hide','objrenameLayer','','show','hcms_messageLayer','','hide')\" name=\"pic_obj_rename\" src=\"".getthemelocation()."img/button_file_rename.gif\" alt=\"".$text18[$lang]."\" title=\"".$text18[$lang]."\" />\n";}
    else
  ...
  <div class="hcmsToolbarBlock">
    ...
    {echo "<img onClick=\"if (locklayer == false) checkForm_delete();\" ".
           "class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_delete\" src=\"".getthemelocation()."img/button_delete.gif\" alt=\"".$text35[$lang]."\" title=\"".$text35[$lang]."\" />";}
    else
    ...
    if ($page != "" && $page != ".folder")
    {
      ...
      {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_action.php', 'cut', '');\" ".
                     "class=\"hcmsButton hcmsButtonSizeSquare\" ".
                     "name=\"pic_obj_cut\" ".
                     "src=\"".getthemelocation()."img/button_file_cut.gif\" alt=\"".$text19[$lang]."\" title=\"".$text19[$lang]."\" />\n";}
      else
      ...
      {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_action.php', 'copy', '');\" ".
                     "class=\"hcmsButton hcmsButtonSizeSquare\" ".
                     "name=\"pic_obj_copy\" ".
                     "src=\"".getthemelocation()."img/button_file_copy.gif\" alt=\"".$text20[$lang]."\" title=\"".$text20[$lang]."\" />\n";}
      else
      ...
      {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_action.php', 'linkcopy', '');\" ".
                     ...
                     "src=\"".getthemelocation()."img/button_file_copylinked.gif\" alt=\"".$text42[$lang]."\" title=\"".$text42[$lang]."\">\n";}
      else
    ...
    elseif ($folder != "")
    {
      ...
      {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_action.php', 'cut', '');\" ".
                     "class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_cut\" src=\"".getthemelocation()."img/button_file_cut.gif\" alt=\"".$text19[$lang]."\" title=\"".$text19[$lang]."\" /></a>\n";}
      else
      {echo "<img src=\"".getthemelocation()."img/button_file_cut.gif\" class=\"hcmsButtonOff hcmsButtonSizeSquare\" />";}
  
      if ($setlocalpermission['root'] == 1 && $setlocalpermission['folderrename'] == 1)
      {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_action.php', 'copy', '');\" ".
                     "class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_copy\" src=\"".getthemelocation()."img/button_file_copy.gif\" alt=\"".$text20[$lang]."\" title=\"".$text20[$lang]."\" /></a>\n";}
      else
      {echo "<img src=\"".getthemelocation()."img/button_file_copy.gif\" class=\"hcmsButtonOff hcmsButtonSizeSquare\" />\n";}
      
      if ($setlocalpermission['root'] == 1 && $setlocalpermission['folderrename'] == 1 && $setlocalpermission['foldercreate'] == 1)
      {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_action.php', 'linkcopy', '');\" ".
                     "class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_linkedcopy\" src=\"".getthemelocation()."img/button_file_copylinked.gif\" alt=\"".$text42[$lang]."\" title=\"".$text42[$lang]."\" />\n";}
      else
      {echo "<img src=\"".getthemelocation()."img/button_file_copylinked.gif\" class=\"hcmsButtonOff hcmsButtonSizeSquare\" />\n";}      
    }
    else
    ...
    {echo "<img onClick=\"if (locklayer == false) submitToWindow('popup_status.php', 'paste', '');\" ".
                   "class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_paste\" src=\"".getthemelocation()."img/button_file_paste.gif\" alt=\"".$text21[$lang]."\" title=\"".$text21[$lang]."\" />\n";}
    else
  ...
  <div class="hcmsToolbarBlock">
    ...
    if ($page != "" && $page != ".folder")
    {
      if (($filetype != "" || $multiobject != "") && $setlocalpermission['root'] == 1 && $setlocalpermission['publish'] == 1)
      {
        ...
        echo "\" ".
        "class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_publish\" src=\"".getthemelocation()."img/button_file_publish.gif\" alt=\"".$text22[$lang]."\" title=\"".$text22[$lang]."\" />\n";
      }
      else
      ...
      if (($filetype != "" || $multiobject != "") && $setlocalpermission['root'] == 1 && $setlocalpermission['publish'] == 1)
      {
        ...
        if ($mgmt_config['db_connect_rdbms'] != "") echo "submitToWindow('popup_publish.php', 'unpublish', '', 'scrollbars=no,resizable=no', '400', '320');";
      	...
      	"src=\"".getthemelocation()."img/button_file_unpublish.gif\" alt=\"".$text23[$lang]."\" title=\"".$text23[$lang]."\" />\n";
      }
      else
      {
    ...
    elseif ($folder != "")
    {
      ...
      if ($setlocalpermission_ACCESS['root'] == 1 && $setlocalpermission_ACCESS['publish'] == 1)
      {
      	...
      	echo "\" class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_unpublish\" src=\"".getthemelocation()."img/button_file_unpublish.gif\" alt=\"".$text23[$lang]."\" title=\"".$text23[$lang]."\">\n";
      }
      else
      {
        echo "<img src=\"".getthemelocation()."img/button_file_unpublish.gif\" class=\"hcmsButtonOff hcmsButtonSizeSquare\" />\n";
  ...
  <div class="hcmsToolbarBlock">
    ...
    {
      // logout button
      echo "<img onClick=\"top.location.href='userlogout.php';\" class=\"hcmsButton hcmsButtonSizeSquare\" name=\"pic_obj_logout\" src=\"".getthemelocation()."img/button_logout.gif\" alt=\"".$text53[$lang]."\" title=\"".$text53[$lang]."\" /></td>\n";
    }
    ?>
  </div>
</div>
...
<div id="filterLayer" class="hcmsToolbarBlock" style="margin: 3px; visibility:<?php if (is_array ($objectfilter) && sizeof ($objectfilter) > 0) echo "visible"; else echo "hidden"; ?>">
  <form name="filter_set" action="explorer_objectlist.php" target="mainFrame" method="get">
    ...
    <input type="checkbox" onclick="setfilter();" name="filter[comp]" value="1" <?php if (isset ($objectfilter['comp']) && $objectfilter['comp'] == 1) echo "checked=\"checked\""; ?>/><label for="filter1" class="hcmsTextSmall"><?php echo $text84[$lang]; ?></label>&nbsp;&nbsp;
    <input type="checkbox" onclick="setfilter();" name="filter[image]" value="1" <?php if (isset ($objectfilter['image']) && $objectfilter['image'] == 1) echo "checked=\"checked\""; ?>/><label for="filter2" class="hcmsTextSmall"><?php echo $text85[$lang]; ?></label>&nbsp;&nbsp;
    <input type="checkbox" onclick="setfilter();" name="filter[document]" value="1" <?php if (isset ($objectfilter['document']) && $objectfilter['document'] == 1) echo "checked=\"checked\""; ?>/><label for="filter3" class="hcmsTextSmall"><?php echo $text86[$lang]; ?></label>&nbsp;&nbsp;
    <input type="checkbox" onclick="setfilter();" name="filter[video]" value="1" <?php if (isset ($objectfilter['document']) && $objectfilter['video'] == 1) echo "checked=\"checked\""; ?>/><label for="filter4" class="hcmsTextSmall"><?php echo $text87[$lang]; ?></label>&nbsp;&nbsp;
    <input type="checkbox" onclick="setfilter();" name="filter[audio]" value="1" <?php if (isset ($objectfilter['audio']) && $objectfilter['audio'] == 1) echo "checked=\"checked\""; ?>/><label for="filter5" class="hcmsTextSmall"><?php echo $text88[$lang]; ?></label>&nbsp;&nbsp;
  </form>
</div>
<?php } ?>
  ...
  <table width="100%" height="60" border="0" cellspacing="4" cellpadding="0">
    <tr>
      ...
      <td width="16" align="right" valign="top">
        <img name="hcms_mediaClose1" src="<?php echo getthemelocation(); ?>img/button_close.gif" class="hcmsButtonTinyBlank hcmsButtonSizeSquare" alt="<?php echo $text34[$lang]; ?>" title="<?php echo $text34[$lang]; ?>" onMouseOut="hcms_swapImgRestore();" onMouseOver="hcms_swapImage('hcms_mediaClose1','','<?php echo getthemelocation(); ?>img/button_close_over.gif',1);" onClick="hcms_showHideLayers('foldercreateLayer','','hide');" />
      </td>      
    </tr>
  </table>
</form>
...
<form name="folder_rename" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return checkForm_folder_rename();">
  ...
  <table width="100%" height="60" border="0" cellspacing="4" cellpadding="0">
    <tr>
      ...
      <td width="16" align="right" valign="top">
        <img name="hcms_mediaClose2" src="<?php echo getthemelocation(); ?>img/button_close.gif" class="hcmsButtonTinyBlank hcmsButtonSizeSquare" alt="<?php echo $text34[$lang]; ?>" title="<?php echo $text34[$lang]; ?>" onMouseOut="hcms_swapImgRestore();" onMouseOver="hcms_swapImage('hcms_mediaClose2','','<?php echo getthemelocation(); ?>img/button_close_over.gif',1);" onClick="hcms_showHideLayers('folderrenameLayer','','hide');" />
      </td>        
    </tr>
  </table>
</form>
...
<form name="page_rename" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return checkForm_folder_rename();">
  ...
  <table width="100%" height="60" border="0" cellspacing="2" cellpadding="0">
    <tr>
      <td valign="middle">
        <?php echo $text18[$lang];  if ($filetype == "Page" || $filetype == "Component") echo " ".$text27[$lang]; ?>: 
      ...
      <td width="16" align="right" valign="top">
        <img name="hcms_mediaClose3" src="<?php echo getthemelocation(); ?>img/button_close.gif" class="hcmsButtonTinyBlank hcmsButtonSizeSquare" alt="<?php echo $text34[$lang]; ?>" title="<?php echo $text34[$lang]; ?>" onMouseOut="hcms_swapImgRestore();" onMouseOver="hcms_swapImage('hcms_mediaClose3','','<?php echo getthemelocation(); ?>img/button_close_over.gif',1);" onClick="hcms_showHideLayers('objrenameLayer','','hide');" />
      </td>      
    </tr>
  </table>
</form>
...
<form name="page_zip" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  ...
  <table width="100%" height="60" border="0" cellspacing="2" cellpadding="0">
    <tr>
      ...
      <td width="16" align="right" valign="top">
        <img name="hcms_mediaClose4" src="<?php echo getthemelocation(); ?>img/button_close.gif" class="hcmsButtonTinyBlank hcmsButtonSizeSquare" alt="<?php echo $text34[$lang]; ?>" title="<?php echo $text34[$lang]; ?>" onMouseOut="hcms_swapImgRestore();" onMouseOver="hcms_swapImage('hcms_mediaClose4','','<?php echo getthemelocation(); ?>img/button_close_over.gif',1);" onClick="hcms_showHideLayers('zipLayer','','hide');" />
      </td>       
    </tr>
  </table>
</form>

  ...
  if (valid_publicationname ($site) && valid_locationname ($location) && valid_objectname ($file) && valid_objectname ($container) && valid_objectname ($user))
  {
    ...
    if ($container_content != false && $container_content != "" && ($usedby == "" || $usedby == $user) && $file_ext != "")
    {
      ...
      if (($file_ext == ".pdf" || $file_ext == ".ai") && $mgmt_parser['.pdf'] != "")
      {
        ...
        @exec ($mgmt_parser['.pdf']." -enc UTF-8 ".$location.$file." -", $file_content, $errorCode); 
      ...
      elseif (($file_ext == ".odt" || $file_ext == ".ods" || $file_ext == ".odp") && $mgmt_uncompress['.zip'] != "")   
        ...
        $cmd = $mgmt_uncompress['.zip']." \"".$location.$file."\" content.xml -d \"".$temp_dir."\"";
      ...
      {
        @exec ($mgmt_parser['.doc']." -t -i 1 -m UTF-8.txt ".$location.$file, $file_content, $errorCode); 
      ...
      elseif (($file_ext == ".docx") && $mgmt_uncompress['.zip'] != "")
      {
        ...
        $cmd = $mgmt_uncompress['.zip']." \"".$location.$file."\" word/document.xml -d \"".$temp_dir."\"";
      ...
      elseif (($file_ext == ".xlsx") && $mgmt_uncompress['.zip'] != "")
      {
        ...
        $cmd = $mgmt_uncompress['.zip']." \"".$location.$file."\" xl/sharedStrings.xml -d \"".$temp_dir."\"";
      ...
      elseif (($file_ext == ".pptx" || $file_ext == ".ppsx") && $mgmt_uncompress['.zip'] != "")
      {
        ...
        $cmd = $mgmt_uncompress['.zip']." \"".$location.$file."\" ppt/slides/slide* -d \"".$temp_dir."\"";
        @exec ($cmd, $error_array);

              ...
              if (($check1 || $check2) && $check3)
              {
                ...
                if (!empty ($mgmt_imagepreview[$imagepreview_ext]) && $mgmt_imagepreview[$imagepreview_ext] != "GD")
                {
                  ...
                  if ($file_ext == ".pdf" || $file_ext == ".eps")
                  {
                    ...
                    {
                      $newfile = $file_name.".thumb.jpg";
                      $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$location_source.$file."[0]\" ".$imageresize." ".$imagecolorspace." ".$iccprofile." \"".$location_dest.$newfile."\"";
                    }
                    else 
                    {
                      ...
                      $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$buffer_file."[0]\" ".$imagerotate." ".$imageBrightnessContrast." ".$imageresize." ".$imagecolorspace." ".$iccprofile." ".$imageflip." ".$sepia." ".$sharpen." ".$blur." ".$sketch." ".$paint." \"".$location_dest.$newfile."\"";
                    }
                  ...
                  elseif ($file_ext == ".psd")
                  {
                    if ($type == "thumbnail") $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$location_source.$file."\" -flatten \"".$location_dest.$file_name.".buffer.jpg\"";
                    elseif ($type == "original") $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$buffer_file."\" -flatten \"".$location_dest.$file_name.".buffer.jpg\"";
                    else $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$buffer_file."\" -flatten \"".$location_dest.$file_name.".buffer.jpg\"";
                    ...
                    {              
                      if (@is_file ($location_dest.$file_name.".buffer.jpg"))
                      {
                        ...
                        { 
                          $newfile = $file_name.".thumb.jpg";
                          $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$location_dest.$file_name.".buffer.jpg\" ".$imageresize." ".$imagecolorspace." ".$iccprofile." \"".$location_dest.$newfile."\"";
                        }
                        else
                        {
                          if ($type == "original") $newfile = $file_name.".".$imageformat;
                          ...
                          if ($crop_mode)
                          {
                            $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$location_dest.$file_name.".buffer.jpg\" -crop ".$imagewidth."x".$imageheight."+".$offsetX."+".$offsetY." ".$imageBrightnessContrast." ".$imagecolorspace." ".$iccprofile." \"".$location_dest.$newfile."\"";
                          }
                          else
                          {
           		              $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$location_dest.$file_name.".buffer.jpg\" ".$imageresize." ".$imagerotate." ".$imageBrightnessContrast." ".$imagecolorspace." ".$iccprofile." ".$imageflip." ".$sepia." ".$sharpen." ".$blur." ".$sketch." ".$paint." \"".$location_dest.$newfile."\"";
                          }
                        }
                  ...
                  else
                  {
                    if ($type == "thumbnail")
                    {
                      $cmd = $mgmt_imagepreview[$imagepreview_ext]." -size ".$imagewidth."x".$imageheight." \"".$location_source.$file."[0]\" ".$imageresize." ".$imagecolorspace." ".$iccprofile." \"".$location_dest.$file_name.".buffer.bmp\"";
                    }
                    else
                    {
                      if ($crop_mode)
                      {
                        $cmd = $mgmt_imagepreview[$imagepreview_ext]." -crop ".$imagewidth."x".$imageheight."+".$offsetX."+".$offsetY." ".$imageBrightnessContrast." \"".$buffer_file."[0]\" ".$imagerotate." ".$imagecolorspace." ".$iccprofile." \"".$location_dest.$file_name.".buffer.bmp\"";
                      }
                      else
                      {
                        $cmd = $mgmt_imagepreview[$imagepreview_ext]." -size ".$imagewidth."x".$imageheight." \"".$buffer_file."[0]\" ".$imageresize." ".$imagerotate." ".$imageBrightnessContrast." ".$imagecolorspace." ".$iccprofile." ".$imageflip." ".$sepia." ".$sharpen." ".$blur." ".$sketch." ".$paint." \"".$location_dest.$file_name.".buffer.bmp\"";
                      }
                    }
                    ...
                    {          
                      if (@is_file ($location_dest.$file_name.".buffer.bmp"))
                      {
                        ...
                        {
                          $newfile = $file_name.".thumb.jpg";
                          $cmd = $mgmt_imagepreview[$imagepreview_ext]." \"".$location_dest.$file_name.".buffer.bmp\" ".$imagecolorspace." ".$iccprofile." \"".$location_dest.$newfile."\"";
                        }
                        else
                        {
                          if ($type == "original") $newfile = $file_name.".".$imageformat;
          ...
          if ($file_ext != "" && substr_count ($mediapreview_ext.".", $file_ext.".") > 0)
          {
            ...
            foreach ($mgmt_mediaoptions as $mediaoptions_ext => $mediaoptions)
            {
              ...
              {        
                ...
                $cmd = $mgmt_mediapreview[$mediapreview_ext]." -i \"".$location_source.$file."\" ".$mgmt_mediaoptions[$mediaoptions_ext]." \"".$location_dest.$tmpfile."\"";
                ...
                {  
                  if (@filesize ($location_dest.$tmpfile) > 10)
                  {
                    ...
                    if ($mgmt_mediametadata['.flv'] != "" && $format_set == "flv")
                    {
                      ...
                      $cmd = $mgmt_mediametadata['.flv']." -i \"".$location_dest.$tmpfile."\" -o \"".$location_dest.$tmpfile2."\"";
    ...
    if (!is_dir ($location.$folder."/"))
    {
      ...
      for ($i = 1; $i <= sizeof ($mgmt_uncompress); $i++)
      {
        ...
        if (substr_count ($extension, $file_ext) > 0)
        {
          ...
          {            
            $cmd = $mgmt_uncompress[$extension]." \"".$zipfilepath."\" -d \"".$temp_dir."\"";         
...
function zipfiles ($site, $multiobject_array, $destination="", $zipfilename, $user, $activity="")
{
  ...
  {  
    ...
    { 
      $cmd = "cd \"".$location."\" & ".$mgmt_compress['.zip']." -r \"".$destination.$zipfilename.".zip\" ".$filesToZip;  
      $cmd = str_replace ("/", "\\", $cmd);
    }
    // UNIX
    else $cmd = "cd \"".$tempFolder."\" ; ".$mgmt_compress['.zip']." -r \"".$destination.$zipfilename.".zip\" *";

...
<div style="padding:0; width:100%; z-index:1;">
  <form name="editor" method="post" action="<?php echo $mgmt_config['url_path_cms']; ?>page_save.php">
    ...
    <table border="0" cellspacing="2">
      <tr>
        <td>
        <img name="Button_so" src="<?php echo getthemelocation(); ?>img/button_save.gif" class="hcmsButton hcmsButtonSizeSquare" onClick="setsavetype('editorc_so');" alt="<?php echo $hcms_lang['save'][$lang_sec]; ?>" title="<?php echo $hcms_lang['save'][$lang]; ?>" />
        <img name="Button_sc" src="<?php echo getthemelocation(); ?>img/button_saveclose.gif" class="hcmsButton hcmsButtonSizeSquare" onClick="setsavetype('editorc_sc');" alt="<?php echo $hcms_lang['save-and-close'][$lang]; ?>" title="<?php echo $hcms_lang['save-and-close'][$lang]; ?>" />
        <br />

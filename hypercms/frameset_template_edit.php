...
<body style="width:100%; height:100%; margin:0; padding:0;">
  ...
  <div style="position:fixed; top:24px; right:0; bottom:0; left:0; margin:0; padding:0;">
    <iframe id="mainFrame2" name="mainFrame2" src="<?php echo "template_edit.php?site=".$site."&cat=".$cat."&template=".$template; ?>" frameBorder="0" style="width:100%; height:100%; border:0; margin:0; padding:0;"></iframe>
  </div>
</frameset>
<noframes></noframes>
</html>
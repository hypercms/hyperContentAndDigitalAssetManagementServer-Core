...
if ($pagestore != false)
{
  ...
  if ($contentfile != "" && $template != "")
  {
    ...
    if (linking_valid() == false)
    {
      ...
      if (!empty ($filedirectlink)) echo "<tr><td style=\"vertical-align:top;\">".getescapedtext ($hcms_lang['direct-link'][$lang])." <img src=\"".getthemelocation()."img/button_file_copy.png\" class=\"hcmsButtonTiny hcmsIconList\" onclick=\"hcms_copyToClipboard('".$filedirectlink."');\" alt=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" title=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" /> </td><td class=\"hcmsHeadlineTiny\" style=\"vertical-align:top; word-break:break-all;\">".$filedirectlink."</td></tr>\n";
      if (!empty ($filestreamlink)) echo "<tr><td style=\"vertical-align:top;\">".getescapedtext ($hcms_lang['link'][$lang]." ".$hcms_lang['for-videoplayer'][$lang])." <img src=\"".getthemelocation()."img/button_file_copy.png\" class=\"hcmsButtonTiny hcmsIconList\" onclick=\"hcms_copyToClipboard('".$filestreamlink."');\" alt=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" title=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" /> </td><td class=\"hcmsHeadlineTiny\" style=\"vertical-align:top; word-break:break-all;\">".$filestreamlink."</td></tr>\n";
      if (!empty ($filewrapperlink)) echo "<tr><td style=\"vertical-align:top;\">".getescapedtext ($hcms_lang['wrapper-link'][$lang])." <img src=\"".getthemelocation()."img/button_file_copy.png\" class=\"hcmsButtonTiny hcmsIconList\" onclick=\"hcms_copyToClipboard('".$filewrapperlink."');\"  alt=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" title=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" /> </td><td class=\"hcmsHeadlineTiny\" style=\"vertical-align:top; word-break:break-all;\">".$filewrapperlink."</td></tr>\n";
      if (!empty ($filewrapperdownload)) echo "<tr><td style=\"vertical-align:top;\">".getescapedtext ($hcms_lang['download-link'][$lang])." <img src=\"".getthemelocation()."img/button_file_copy.png\" class=\"hcmsButtonTiny hcmsIconList\" onclick=\"hcms_copyToClipboard('".$filewrapperdownload."');\" alt=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" title=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" /> </td><td class=\"hcmsHeadlineTiny\" style=\"vertical-align:top; word-break:break-all;\">".$filewrapperdownload."</td></tr>\n";
      if (!empty ($fileaccesslink)) echo "<tr><td style=\"vertical-align:top;\">".getescapedtext ($hcms_lang['access-link'][$lang])." <img src=\"".getthemelocation()."img/button_file_copy.png\" class=\"hcmsButtonTiny hcmsIconList\" onclick=\"hcms_copyToClipboard('".$fileaccesslink."');\" alt=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" title=\"".getescapedtext ($hcms_lang['copy'][$lang])."\" /> </td><td class=\"hcmsHeadlineTiny\" style=\"vertical-align:top; word-break:break-all;\">".$fileaccesslink."</td></tr>\n";
    }

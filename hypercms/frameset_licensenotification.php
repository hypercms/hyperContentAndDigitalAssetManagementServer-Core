...
<body style="width:100%; height:100%; margin:0; padding:0;" onload="adjust_height(); adjust_width();" onresize="adjust_height(); adjust_width();">
  <iframe id="navFrame2" name="navFrame2" scrolling="auto" src="<?php echo "folder_explorer.php?site=".$site."&cat=".$cat; ?>" style="position:fixed; top:0px; left:0px; width:250px; height:100%; border:0; margin:0; padding:0;"></iframe>
  <iframe id="mainFrame2" name="mainFrame2" scrolling="auto" src="<?php echo "licensenotification_form.php?site=".$site."&cat=".$cat; ?>" style="position:fixed; top:0px; left:250px; width:100%; height:100%; border:0; margin:0; padding:0;"></iframe>
</body>
</html>
...
<body class="hcmsTransBackground">
  <iframe id="controlFrame" name="controlFrame" src="control_log_menu.php?site=<?php echo $site; ?>" frameBorder="0" scrolling="no" style="position:fixed; top:0; left:0; width:100%; height:78px; border:0; margin:0; padding:0; overflow:hidden;"></iframe>

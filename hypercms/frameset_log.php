...
<body style="width:100%; height:100%; margin:0; padding:0;" onload="adjust_height();" onresize="adjust_height();">
  <iframe id="controlFrame" name="controlFrame" scrolling="no" src="control_log_menu.php?site=<?php echo $site; ?>" style="position:fixed; top:0; left:0; width:100%; height:100px; border:0; margin:0; padding:0;"></iframe>
  <iframe id="mainFrame" name="mainFrame" scrolling="no" src="log_list.php?site=<?php echo $site; ?>" style="position:fixed; top:100px; left:0; width:100%; height:100%; border:0; margin:0; padding:0;"></iframe>
</body>
</html>
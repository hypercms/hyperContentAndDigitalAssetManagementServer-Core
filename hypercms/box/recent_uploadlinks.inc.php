...
$stats_array = rdbms_getmediastat ("", "", "upload", "", "", $user, false);
...
if (is_array ($object_array) && sizeof ($object_array) > 0)
{
  ...
  <div id=\"recent_downloads\" class=\"hcmsHomeBox\" style=\"margin:10px; width:".$width."; height:400px; float:left;\">
    <div class=\"hcmsHeadline\" style=\"margin:2px;\">".getescapedtext ($hcms_lang['my-recent-uploads'][$lang])." / ".getescapedtext ($hcms_lang['download-link'][$lang])." / ".getescapedtext ($hcms_lang['access-link'][$lang])."</div>";

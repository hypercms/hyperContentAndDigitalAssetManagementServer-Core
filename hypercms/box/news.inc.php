...
if (!empty ($mgmt_config['homebox_welcome']))
{
  ...
  <div id=\"newsbox\" class=\"hcmsHomeBox\" style=\"text-align:left; width:".$width."; height:400px; margin:10px; overflow:hidden;\">
    <div style=\"display:block; padding:0; margin:0;\">
      ...
      <div style=\"float:right;\"><img class=\"hcmsButtonTiny\" style=\"width:22px; height:22px; margin:6px;\" onclick=\"hcms_minMaxLayer('newsbox');\" src=\"".getthemelocation()."img/edit_drag.png\" alt=\"".getescapedtext ($hcms_lang['enable-fullscreen'][$lang])."\" title=\"".getescapedtext ($hcms_lang['enable-fullscreen'][$lang])."\" /></div>
    </div>

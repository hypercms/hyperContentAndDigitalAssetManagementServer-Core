...
<body style="width:100%; height:100%; margin:0; padding:0;">
  <iframe name="controlFrame" scrolling="no" src="<?php echo "control_report_menu.php"; ?>" frameBorder="0" style="position:fixed; top:0; left:0; width:100%; height:100px; border:0; margin:0; padding:0;"></iframe>
  <div style="position:fixed; top:100px; right:0; bottom:0; left:0; margin:0; padding:0; <?php echo $css_iphone; ?>">
    <iframe name="mainFrame" scrolling="auto" src="../empty.php" frameBorder="0" style="width:100%; height:100%; border:0; margin:0; padding:0;"></iframe>
  </div>
</body>
</html>
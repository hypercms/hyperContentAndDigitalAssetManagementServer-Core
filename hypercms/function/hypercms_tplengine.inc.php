...
function buildview ($site, $location, $page, $user, $buildview="template", $ctrlreload="no", $template="", $container="", $force_cat="", $execute_code=true, $recognizefaces_service=false)
{
  ...
  // eventsystem
  if (!empty ($eventsystem['oneditobject_pre']) && $eventsystem['hide'] == 0 && ($buildview == "cmsview" || $buildview == "inlineview") && function_exists ("oneditobject_pre"))
  {
...
<body class=\"hcmsWorkplaceGeneric\">
  ...
  <body class=\"hcmsWorkplaceGeneric\">
    <p class=\"hcmsHeadline\">".getescapedtext ($hcms_lang['please-do-not-use-the-following-special-characters-in-the-content-identification-name'][$lang], $charset, $lang)." '".$id."':<br/>[\]{}()*+?.,\\^$</p>
            ...
            if ($toolbar == "" && !empty ($mgmt_config[$site]['dam'])) $toolbar = "DAM";
  ...
  <body class=\"hcmsWorkplaceGeneric\">
                ...
                if ($hypertagname == $searchtag."k")
                {
                  ...
                  while (!empty ($hypertag) && substr_count ($viewstore_offset, $hypertag) > 0)
                  {
                    ...
                    if ($searchtag == "text")
                    {
                      ...
                      {
                        $taglink = "<img src=\"".getthemelocation()."img/edit_textk.png\" onclick=\"location.hypercms_href='".cleandomain ($mgmt_config['url_path_cms'])."text_edit_keywords.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&db_connect=".url_encode($db_connect)."&id=".url_encode($id)."&label=".url_encode($label)."&tagname=".url_encode($hypertagname)."&display=".url_encode($display)."&list=".url_encode($list_add)."&file=".url_encode($list_sourcefile)."&onlylist=".url_encode($onlylist)."&constraint=".url_encode($constraint)."&contenttype=".url_encode($contenttype)."&width=".url_encode($sizewidth)."&height=".url_encode($sizeheight)."&default=".url_encode($defaultvalue)."&token=".$token."';\" alt=\"".$labelname.": ".getescapedtext ($hcms_lang['keywords'][$lang], $charset, $lang)."\" title=\"".$labelname.": ".getescapedtext ($hcms_lang['keywords'][$lang], $charset, $lang)."\" style=\"all:unset; display:inline !important; width:20px; height:20px; border:0; cursor:pointer; z-index:9999999;\" />\n";
                      }
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                      {
                        ...
                        if ($display == "taxonomy")
                        {
                          ...
                          <div class=\"hcmsFormRowContent ".$hypertagname."_".$id."\" style=\"position:relative; width:".$sizewidth.(strpos ($sizewidth, "%") > 0 ? "" : "px")."; height:".$sizeheight."px;\">
                            ".showtaxonomytree ($site, $container_id, $id, $hypertagname, $lang, $list_sourcefile, $sizewidth, $sizeheight, $charset)."
                          </div>";
                        }
                        ...
                        else
                        {
                          ...
                          if ($list != "")
                          {
                            ...
                            if ($onlylist == "yes" || $onlylist == "true" || $onlylist == "1")
                            {
                    ...
                    elseif ($searchtag == "arttext")
                    {
                      ...
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                      {
                        ...
                        else
                        {
                          ...
                          if ($constraint != "") $constraint_array[$key] = "'".$hypertagname."_".$artid."_".$elementid."', '".$labelname."', '".$constraint."'";
    ...
    $('#".$hypertagname."_".$id."').tagit({".$keywords_tagit.(!empty ($disabled) ? "readOnly:true, " : "")."singleField:true, allowSpaces:true, singleFieldDelimiter:',', singleFieldNode:$('#".$hypertagname."_".$artid."_".$elementid."')});";
                          ...
                          <div class=\"hcmsFormRowContent ".$hypertagname."_".$artid."_".$elementid."\" style=\"position:relative; width:".$sizewidth.(strpos ($sizewidth, "%") > 0 ? "" : "px").";\">
                            <input type=\"hidden\" name=\"".$hypertagname."[".$id."]\" value=\"".$contentbot."\" />
                            <input type=\"text\" id=\"".$hypertagname."_".$artid."_".$elementid."\" name=\"".$hypertagname."_".$artid."_".$elementid."\" style=\"width:".$sizewidth."px;\" ".$disabled." value=\"".$contentbot."\" />
                            <div id=\"".$hypertagname."_".$artid."_".$elementid."_protect\" style=\"position:absolute; top:0; left:0; width:".$sizewidth."px; height:100%; display:none;\"></div>
                          </div>";
                        }
                      }
                      elseif ($buildview == "template" && $onedit != "hidden" && ($infotype != "meta" || strpos ($templatefile, ".meta.tpl") > 0))
                ...
                // ------------------- unformatted text -------------------
                elseif ($hypertagname == $searchtag."u")
                {
                  $repl_offset = 0;
                  $viewstore_offset = $viewstore;
                  ...
                  while (!empty ($hypertag) && substr_count ($viewstore_offset, $hypertag) > 0)
                  {
                    ...
                    {
                      // create tag link for editor
                      if ($buildview == "cmsview" && empty ($readonly))
                      {
                    ...
                    {
                      // create tag link for editor
                      if ($buildview == "cmsview" && $infotype != "meta" && empty ($readonly))
                      {
                        $taglink = "<img src=\"".getthemelocation()."img/edit_textu.png\" onclick=\"location.hypercms_href='".cleandomain ($mgmt_config['url_path_cms'])."text_edit_unformat.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&db_connect=".url_encode($db_connect)."&id=".url_encode($id)."&label=".url_encode($label)."&tagname=".url_encode($hypertagname)."&constraint=".url_encode($constraint)."&contenttype=".url_encode($contenttype)."&width=".url_encode($sizewidth)."&height=".url_encode($sizeheight)."&default=".url_encode($defaultvalue)."&token=".$token."';\" alt=\"".$labelname.": ".getescapedtext ($hcms_lang['edit-unformatted-text'][$lang], $charset, $lang)."\" title=\"".$labelname.": ".getescapedtext ($hcms_lang['edit-unformatted-text'][$lang], $charset, $lang)."\" style=\"all:unset; display:inline !important; width:20px; height:20px; border:0; cursor:pointer; z-index:9999999;\" />".$arttaglink[$artid];
                      }
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                ...
                elseif ($hypertagname == $searchtag."l")
                {
                  ...
                  while (!empty ($hypertag) && substr_count ($viewstore_offset, $hypertag) > 0)
                  {
                    ...
                    if ($searchtag == "text")
                    {
                      ...
                      if ($buildview == "cmsview" && empty ($readonly))
                      {
                        $taglink = "<img src=\"".getthemelocation()."img/edit_textl.png\" onclick=\"location.hypercms_href='".cleandomain ($mgmt_config['url_path_cms'])."text_edit_list.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&db_connect=".url_encode($db_connect)."&id=".url_encode($id)."&label=".url_encode($label)."&tagname=".url_encode($hypertagname)."&list=".url_encode($list_add)."&file=".url_encode($list_sourcefile)."&contenttype=".url_encode($contenttype)."&default=".url_encode($defaultvalue)."&token=".$token."';\" alt=\"".$labelname.": ".getescapedtext ($hcms_lang['edit-text-options'][$lang], $charset, $lang)."\" title=\"".$labelname.": ".getescapedtext ($hcms_lang['edit-text-options'][$lang], $charset, $lang)."\" style=\"all:unset; display:inline !important; width:20px; height:20px; border:0; cursor:pointer; z-index:9999999;\" />\n";
                      }
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                      {
                        // get list entries
                ...
                elseif ($hypertagname == $searchtag."c")
                {
                  ...
                  { 
                    if ($searchtag == "text")
                    {
                      ...
                      if ($buildview == "cmsview" && empty ($readonly))
                      {
                        $taglink = "<img src=\"".getthemelocation()."img/edit_textc.png\" onclick=\"location.hypercms_href='".cleandomain ($mgmt_config['url_path_cms'])."text_edit_checkbox.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&db_connect=".url_encode($db_connect)."&id=".url_encode($id)."&label=".url_encode($label)."&tagname=".url_encode($hypertagname)."&contenttype=".url_encode($contenttype)."&value=".url_encode($value)."&default=".url_encode($defaultvalue)."&token=".$token."';\" alt=\"".$labelname.": ".getescapedtext ($hcms_lang['set-checkbox'][$lang], $charset, $lang)."\" title=\"".$labelname.": ".getescapedtext ($hcms_lang['set-checkbox'][$lang], $charset, $lang)."\" style=\"all:unset; display:inline !important; width:20px; height:20px; border:0; cursor:pointer; z-index:9999999;\" />\n";
                      }
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                      {
                    ...
                    elseif ($searchtag == "arttext")
                    {
                      ...
                      if ($buildview == "cmsview" && empty ($readonly))
                      {
                        $taglink = "<img src=\"".getthemelocation()."img/edit_textc.png\" onclick=\"location.hypercms_href='".cleandomain ($mgmt_config['url_path_cms'])."text_edit_checkbox.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&db_connect=".url_encode($db_connect)."&id=".url_encode($id)."&label=".url_encode($label)."&tagname=".url_encode($hypertagname)."&contenttype=".url_encode($contenttype)."&value=".url_encode($value)."&default=".url_encode($defaultvalue)."&token=".$token."';\" style=\"all:unset; display:inline !important;\" alt=\"".$labelname.": ".getescapedtext ($hcms_lang['set-checkbox'][$lang], $charset, $lang)."\" title=\"".$labelname.": ".getescapedtext ($hcms_lang['set-checkbox'][$lang], $charset, $lang)."\" style=\"all:unset; display:inline !important; width:20px; height:20px; border:0; cursor:pointer; z-index:9999999;\" />".$arttaglink[$artid]."\n";
                      }
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                      {
                        if ($value == $contentbot) $checked = " checked";
                ...
                elseif ($hypertagname == $searchtag."d")
                {
                  ...
                  { 
                    if ($searchtag == "text")
                    {
                      ...
                      if ($buildview == "cmsview" && empty ($readonly))
                      {
                        $taglink = "<img src=\"".getthemelocation()."img/edit_textd.png\" onclick=\"location.hypercms_href='".cleandomain ($mgmt_config['url_path_cms'])."text_edit_date.php?site=".url_encode($site)."&cat=".url_encode($cat)."&location=".url_encode($location_esc)."&page=".url_encode($page)."&db_connect=".url_encode($db_connect)."&id=".url_encode($id)."&label=".url_encode($label)."&tagname=".url_encode($hypertagname)."&contenttype=".url_encode($contenttype)."&format=".url_encode($format)."&default=".url_encode($defaultvalue)."&token=".$token."';\" alt=\"".$labelname.": ".getescapedtext ($hcms_lang['pick-a-date'][$lang], $charset, $lang)."\" title=\"".$labelname.": ".getescapedtext ($hcms_lang['pick-a-date'][$lang], $charset, $lang)."\" style=\"all:unset; display:inline !important; width:20px; height:20px; border:0; cursor:pointer; z-index:9999999;\" />\n";
                      }
                      elseif (($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock") && isset ($foundtxt[$id]) && $foundtxt[$id] == true)
                      { 
            ...
            if ($buildview != "template")
            {
              ...
              if ($db_connect_data == false)
              {
                ...
                if (empty ($mediabot[$id]))
                {
                  ...
                  if (!empty ($temp_array[0])) $mediabot[$id] = $temp_array[0];
                }
                ...
                if (!empty ($mediabot[$id]))
                {
                  ...
                  {
                    $temp_array = getcontent ($mediabot[$id], "<mediafile>");
                    if (!empty ($temp_array[0])) $mediafilebot[$id][$tagid] = $temp_array[0];

                    $temp_array = getcontent ($mediabot[$id], "<mediaobject>");
                    if (!empty ($temp_array[0])) $mediaobjectbot[$id] = $temp_array[0];
                      ...
                      elseif ($buildview == "formedit" || $buildview == "formmeta" || $buildview == "formlock")
                      {
                        ...
                        if ($mediaalttextbot[$id] != "*Null*") $formitem[$key] .= "
                          <tr>
                            ...
                            <td><input type=\"text\" id=\"".$hypertagname_text[$id]."_".$id."\" name=\"".$hypertagname_text[$id]."[".$id."]\" value=\"".$mediaalttextbot[$id]."\" style=\"width:".$fieldwidth."px;\" maxlength=\"255\" ".$disabled." /></td>
                          </tr>";
                        ...
                        if ($mediawidthbot[$id] != "*Null*")
                        {
                          ...
                          <tr>
                            ...
                            <td><input type=\"number\" name=\"".$hypertagname_width[$id]."[".$id."]\" value=\"".$mediawidthbot[$id]."\" style=\"width:60px;\" min=\"0\" max=\"99999\" ".$disabled." /></td>
                          </tr>";
                        }
                        ...
                        if ($mediaheightbot[$id] != "*Null*")
                        {
                          ...
                          <tr>
                            ...
                            <td><input type=\"number\" name=\"".$hypertagname_height[$id]."[".$id."]\" value=\"".$mediaheightbot[$id]."\" style=\"width:60px;\" min=\"0\" max=\"99999\" ".$disabled." /></td>
                          </tr>";
                        }
                    ...
                    elseif ($searchtag == "artmedia")
                    {
                      ...
                      elseif ($buildview == "formedit" || ($buildview == "formmeta" && @$infotype[$id] == "meta") || $buildview == "formlock")
                      {
                        ...
                        if ($mediaalttextbot[$id] != "*Null*") $formitem[$key] .= "
                          <tr>
                            ...
                            <td>
                              ...
                              <input type=\"text\" name=\"".$hypertagname_text[$id]."_".$artid."_".$elementid."\" value=\"".$mediaalttextbot[$id]."\" style=\"width:".$fieldwidth."px;\" maxlength=\"255\" ".$disabled." />
                            </td>
                          </tr>";
                        ...
                        if ($mediawidthbot[$id] != "*Null*")
                        {
                          ...
                          <tr>
                            <td style=\"width:150px;\">".getescapedtext ($hcms_lang['width'][$lang], $charset, $lang)." </td>
                            <td><input type=\"number\" id=\"".$hypertagname_width[$id]."_".$artid."_".$elementid."\" name=\"".$hypertagname_width[$id]."[".$id."]\" value=\"".$mediawidthbot[$id]."\" style=\"width:60px;\" min=\"0\" max=\"99999\" ".$disabled." /></td>
                          </tr>";
                        }
                        ...
                        if ($mediaheightbot[$id] != "*Null*")
                        {
                          ...
                          <tr>
                            <td style=\"width:150px;\">".getescapedtext ($hcms_lang['height'][$lang], $charset, $lang)." </td>
                            <td><input type=\"number\" id=\"".$hypertagname_height[$id]."_".$artid."_".$elementid."\" name=\"".$hypertagname_height[$id]."[".$id."]\" value=\"".$mediaheightbot[$id]."\" style=\"width:60px;\" min=\"0\" max=\"99999\" ".$disabled."></td>
                          </tr>";
                        }
                        ...
                        if ($linktextbot[$id] != "*Null*")
                        {
                          $formitem[$key] .= "
                              <tr>
                                ...
                                <td>
                                  <input type=\"text\" name=\"".$hypertagname_text[$id]."[".$id."]\" value=\"".$linktextbot[$id]."\" style=\"width:".$fieldwidth."px;\" maxlength=\"255\" ".$disabled." />
                                </td>
                              </tr>";
                        }
                        ...
                        if ($linktextbot[$id] != "*Null*")
                        {
                          $formitem[$key] .= "
                              <tr>
                                ...
                                <td>
                                  <input type=\"text\" id=\"".$hypertagname_text[$id]."_".$id."\" name=\"".$hypertagname_text[$id]."[".$id."]\" value=\"".$linktextbot[$id]."\" style=\"width:".$fieldwidth."px;\" maxlength=\"255\" ".$disabled." />
                                </td>
                              </tr>";
                        }
    ...
    ";
            ...
            if (@substr_count (strtolower ($viewstore), "<body") > 0 || @substr_count (strtolower ($viewstore), ":body") > 0)
            {
              ...
              if ($buildview == "inlineview")
              {
                ...
                $scriptcode .= "
      <script type=\"text/javascript\">       
      function hcms_checkUpdatedContent ()
      {
        $.ajax({
          type: 'POST',
          url: \"".cleandomain ($mgmt_config['url_path_cms'])."service/checkupdatedcontent.php\",
      ...
      setInterval (hcms_checkUpdatedContent, 3000);
      </script>
      ";
              }
...
";
  ...
  // eventsystem
  if (!empty ($eventsystem['oneditobject_post']) && $eventsystem['hide'] == 0 && ($buildview == "cmsview" || $buildview == 'inlineview') && function_exists ("oneditobject_post"))
  {
    // include hyperCMS Event System
    @include_once ($mgmt_config['abs_path_data']."eventsystem/hypercms_eventsys.inc.php");

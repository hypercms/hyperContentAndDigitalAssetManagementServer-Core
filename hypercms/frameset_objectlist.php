...
elseif ($action == "user_files")
{
  ...
  echo "<iframe id=\"controlFrame\" name=\"controlFrame\" scrolling=\"".$scrolling."\" src=\"loading.php\" border=\"0\" style=\"width:100%; height:100px; border:0; margin:0; padding:0; float:left;\"></iframe>\n";
  // object list
  echo "<iframe id=\"mainFrame\" name=\"mainFrame\" scrolling=\"NO\" src=\"search_script_rdbms.php?action=".$action."&site=".$site."&login=".$login."\" border=\"0\" style=\"width:".$objectlist_width."%; height:100%; border:0; margin:0; padding:0; float:left;\"></iframe>\n";
  // sidebar

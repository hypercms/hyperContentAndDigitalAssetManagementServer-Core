...
if (isset ($wf_file) && @is_file ($mgmt_config['abs_path_data']."workflow_master/".$wf_file))
{
 ...
 else $show = getescapedtext ($hcms_lang['could-not-access-workflow'][$lang]); 
}
...
{  
  ...
  for ($stage=$stage_start; $stage<=$stage_max; $stage++)
  {
    ...
    foreach ($item_allstages_array[$stage] as $item)
    {
      ...
      {        
        $itemtype = getescapedtext ($hcms_lang['user'][$lang]);
      ...
      elseif ($type == "script")
      {
        ...
        $itemtype = getescapedtext ($hcms_lang['script'][$lang]);
      ...
      echo "<div id=\"LayerItem".$id."\" style=\"position:absolute; width:70px; height:70px; z-index:".$z1."; left:".$x."px; top:".$y."px; visibility:visible\">
              <div id=\"LayerDrag".$id."\">
                <table width=\"80px\" height=\"80px\" cellspacing=0 cellpadding=2 class=\"hcmsContextMenu\">
                  <tr>
                    <td align=middle>
                      <a href=\"#\" onClick=\"hcms_showHideLayers('LayerProp".$id."','','show')\"><b>"; if ($id == "u.1") echo getescapedtext ($hcms_lang['start'][$lang]); else echo $itemtype." ".$id_suffix; echo "</b></a>
                    </td>
                  </tr>
                  <tr>
          ...
          <tr>
            <td align=\"left\" valign=\"top\">
                <table width=\"100%\" border=0 cellspacing=0 cellpadding=0 class=\"hcmsWorkplaceWorkflow\">
                  <tr>
                    <td class=\"hcmsHeadline\" style=\"text-align:left; vertical-align:middle; padding:2px 1px 1px 6px\">".getescapedtext ($hcms_lang['properties'][$lang])." ".$itemtype." ".$id_suffix."</td>
                    <td style=\"width:26px; text-align:right; vertical-align:middle;\">
                      <a href=\"#\" onMouseOut=\"hcms_swapImgRestore()\" onMouseOver=\"hcms_swapImage('mediaClose".$id."','','".getthemelocation()."img/button_close_over.gif',1)\">
                        <img name=\"mediaClose".$id."\" src=\"".getthemelocation()."img/button_close.gif\" class=\"hcmsButtonBlank hcmsButtonSizeSquare\" onClick=\"hcms_showHideLayers('LayerProp".$id."','','hide')\" title=\"".getescapedtext ($hcms_lang['close'][$lang])."\" alt=\"".getescapedtext ($hcms_lang['close'][$lang])."\" />
                      </a>
                    </td>
                  </tr>
                </table>
                ...
                if ($type == "user" || $type == "usergroup")
                {
                  ...
                  // user
                  echo "<input type=\"radio\" name=\"type[".$id."]\" value=\"user\" ".$selected_usr." /> ".getescapedtext ($hcms_lang['user'][$lang]).":<br />\n";
                  echo "<select name=\"wfuser[".$id."]\" style=\"width:200px\">\n";                
                  echo "<option value=\"\">----- ".getescapedtext ($hcms_lang['select'][$lang])." -----</option>\n";
                  ...
                  // user group
                  echo "<input type=\"radio\" name=\"type[".$id."]\" value=\"usergroup\" ".$selected_grp." /> ".getescapedtext ($hcms_lang['user-group'][$lang]).":<br />\n";
                ...
                elseif ($type == "script")
                {
                  echo "".getescapedtext ($hcms_lang['script-file'][$lang]).":<br />\n";
                ...
                if ($id != "u.1") 
                {                
                  echo "<img src=\"".getthemelocation()."img/workflow_positive.gif\" style=\"width:21px; height:16px;\" /> ".getescapedtext ($hcms_lang['inherit-from'][$lang]).":<br />\n";
                  
                  if (in_array ("u.1", $pre_array)) $selected = " selected=\"selected\"";
                  else $selected = "";
                                    
                  echo "<select name=\"predecessor[".$id."][]\" size=\"3\" style=\"width:200px;\" multiple>\n";                
                  echo "<option value=\"u.1\" ".$selected.">".getescapedtext ($hcms_lang['start'][$lang])."</option>\n";
                  ...
                  foreach ($id_collect as $id_single)
                  {
                    if ($id_single != $id && $id_single != "u.1")
                    {
                      ...
                      if ($id_single[0] == "u")
                      $select_user[$id_single_suffix] = "<option value=\"".$id_single."\" ".$selected.">".getescapedtext ($hcms_lang['user'][$lang])." ".$id_single_suffix."</option>\n";
                      elseif ($id_single[0] == "s")
                      $select_script[$id_single_suffix] = "<option value=\"".$id_single."\" ".$selected.">".getescapedtext ($hcms_lang['script'][$lang])." ".$id_single_suffix."</option>\n";
                    }
                  }
                  ...
                  // sucessors            
                  echo "<img src=\"".getthemelocation()."img/workflow_negative.gif\" style=\"width:21px; height:16px;\" /> <font color=\"#000000\">".getescapedtext ($hcms_lang['redirect-to'][$lang]).":</font><br />\n";
                ...
                {    
                  ...
                  echo "<img src=\"".getthemelocation()."img/workflow_permission.gif\" style=\"width:21px; height:16px;\" /> <font color=\"#000000\">".getescapedtext ($hcms_lang['permissions'][$lang]).":</font><br />
                  <select name=\"role[".$id."]\" style=\"width:200px\">
                    <option value=\"r\" ".$sel_r.">".getescapedtext ($hcms_lang['read'][$lang])."</option>
                    <option value=\"rw\" ".$sel_rw.">".getescapedtext ($hcms_lang['read-edit'][$lang])."</option>
                    <option value=\"rx\" ".$sel_rx.">".getescapedtext ($hcms_lang['read-publish'][$lang])."</option>
                    <option value=\"rwx\" ".$sel_rwx.">".getescapedtext ($hcms_lang['read-edit-publish'][$lang])."</option>
                  </select><br />\n";
                }        
                ...
                else 
                {
                  ...
                  echo "<font color=\"#000000\">".getescapedtext ($hcms_lang['active'][$lang])."</font>\n";                          
                }
    ...
    <tr>
      <td class="hcmsWorkplaceWorkflow" width="220" align="left" valign="top">
        <table width="100%" height="100%" border="0" cellspacing="2" cellpadding="0">
          <tr>
            <td align="left" valign="top">
              <p class="hcmsHeadline"><?php echo getescapedtext ($hcms_lang['workflow'][$lang]); ?>:</span> <span class="hcmsHeadlineTiny"><?php echo $wf_name; ?></p>
                <!-- toolbar -->
                <div class="hcmsToolbar">
                  <div class="hcmsToolbarBlock">
                    <img onclick="document.forms['workflow'].submit();" class="hcmsButton hcmsButtonSizeSquare" name="Button1" src="<?php echo getthemelocation(); ?>img/button_save.gif" title="<?php echo getescapedtext ($hcms_lang['save'][$lang]); ?>" alt="<?php echo getescapedtext ($hcms_lang['save'][$lang]); ?>" />
                    
                  </div>
                  <div class="hcmsToolbarBlock">
                    <img onClick="adduseritem();" class="hcmsButton hcmsButtonSizeSquare" name="Button2" src="<?php echo getthemelocation(); ?>img/button_user_new.gif" title="<?php echo getescapedtext ($hcms_lang['add-user-item'][$lang]); ?>" alt="<?php echo getescapedtext ($hcms_lang['add-user-item'][$lang]); ?>" />
                    <img onClick="removeuseritem();" class="hcmsButton hcmsButtonSizeSquare" name="Button3" src="<?php echo getthemelocation(); ?>img/button_user_delete.gif" title="<?php echo getescapedtext ($hcms_lang['remove-user-item'][$lang]); ?>" alt="<?php echo getescapedtext ($hcms_lang['remove-user-item'][$lang]); ?>" />
                    
                  </div>
                  <div class="hcmsToolbarBlock">
                    <img onClick="addscriptitem();" class="hcmsButton hcmsButtonSizeSquare" name="Button4" src="<?php echo getthemelocation(); ?>img/button_script_new.gif" title="<?php echo getescapedtext ($hcms_lang['add-script-item'][$lang]); ?>" alt="<?php echo getescapedtext ($hcms_lang['add-script-item'][$lang]); ?>" />
                    <img onClick="removescriptitem();" class="hcmsButton hcmsButtonSizeSquare" name="Button5" src="<?php echo getthemelocation(); ?>img/button_script_delete.gif" title="<?php echo getescapedtext ($hcms_lang['remove-script-item'][$lang]); ?>" alt="<?php echo getescapedtext ($hcms_lang['remove-script-item'][$lang]); ?>" />                                  
                </div>
              </div>
              <p><span class="hcmsHeadline"><?php echo getescapedtext ($hcms_lang['workflow-items'][$lang]); ?>:</span><br />
              <span class="hcmsHeadlineTiny"><font size="1"><?php echo getescapedtext ($hcms_lang['click-and-hold-to-drag-item'][$lang]); ?></font></span></p><br />
            </td>
          </tr>
        </table>
      </td>

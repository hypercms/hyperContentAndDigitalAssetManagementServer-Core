...
{	
  ...
  public function createObject($site, $location, $objectName, $objectContent, $cat)
  {
    ...
    $result = $this->_runFuncWithGlobals('uploadfile', array($site, $location, $cat, $fileArray, 0, "", "", "", "", "", $this->getGlobal('user'), false, false));		
  ...
  public function editObject($site, $location, $objectName, $objectContent, $cat)
  {
    ...
    $result = $this->_runFuncWithGlobals('uploadfile', array($site, $location, $cat, $fileArray, 0, true, "", $objectName, "", "", $this->getGlobal('user'), false, true));
  ...
  protected function _loadSiteConfig($siteName)
  {
    ...
    if (!isset ($mgmt_config[$siteName]) || !is_array ($mgmt_config[$siteName]))
    {
  ...
  protected function _getTmpFolder($folder, $fileName)
  {
    ...
    return $this->_runWithGlobals('"{$mgmt_config["abs_path_cms"]}'."temp/".$folder."/\"");
  }

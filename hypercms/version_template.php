...
<form name="versionform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  ...
  <table border="0" cellspacing="2" cellpadding="3">
    ...
    if (@sizeof ($files_v) >= 1)
    {
      ...
      foreach ($files_v as $file_v)
      {
        ...
        echo "<tr class=\"".$rowcolor."\">
          ...
          <td nowrap=\"nowrap\"><a href=# onClick=\"hcms_openBrWindowItem('template_view.php?site=".url_encode($site)."&cat=".url_encode($cat)."&template=".url_encode($file_v)."','preview','scrollbars=yes,resizable=yes','800','600')\"><img src=\"".getthemelocation()."img/".$file_info['icon']."\" width=16 height=16 border=0 align=\"absmiddle\" />&nbsp; ".$tpl_name."</a> <a href=# onClick=\"hcms_openBrWindowItem('template_source.php?site=".url_encode($site)."&template=".url_encode($file_v)."','sourceview','scrollbars=yes,resizable=yes','800','600')\"><font size=\"-2\">(Source Code)</font></a></td>
    ...
    echo "<tr class=\"hcmsRowHead2\">
      ...
      <td nowrap=\"nowrap\"><a href=# onClick=\"hcms_openBrWindowItem('template_view.php?site=".url_encode($site)."&cat=".url_encode($cat)."&template=".url_encode($template)."','preview','scrollbars=yes,resizable=yes','800','600')\"><img src=\"".getthemelocation()."img/".$file_info['icon']."\" width=16 height=16 border=0 align=\"absmiddle\" />&nbsp; ".$tpl_name."</a> <a href=# onClick=\"hcms_openBrWindowItem('template_source.php?site=".url_encode($site)."&template=".url_encode($template)."','sourceview','scrollbars=yes,resizable=yes','800','600')\"><font size=\"-2\">(Source Code)</font></a></td>

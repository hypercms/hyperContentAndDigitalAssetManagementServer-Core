...
function warning_versions_update()
{
  ...
  check = confirm(hcms_entity_decode("<?php echo $hcms_lang['are-you-sure-to-switch-to-a-previous-template-version'][$lang]; ?>\r<?php echo $hcms_lang['andor-delete-the-selected-versions'][$lang]; ?>"));
...
<form name="versionform" action="" method="post">
  ...
  <table border="0" cellspacing="2" cellpadding="3">
    ...
    if ($versiondir != "" && $actual != "" && checktoken ($token, $user))
    {
      ...
      if ($rename_1 != false)
      {
        ...
        if ($rename_2 == false) echo "<p class=hcmsHeadline>".$hcms_lang['could-not-change-version'][$lang]."</p>\n".$hcms_lang['file-is-missing-or-you-do-not-have-write-permissions'][$lang]."\n";
      }
  ...
  <div style="width:350px; float:left;"><?php echo $hcms_lang['submit-changes-to-versions'][$lang]; ?> :</div>
...
<form name="compareform" action="version_template_compare.php" method="post">
  ...
  <div style="width:350px; float:left;"><?php echo $hcms_lang['compare-selected-versions'][$lang]; ?> :</div>

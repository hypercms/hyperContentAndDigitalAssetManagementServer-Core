...
$text[1]['cz'] = "Výsledky %start% - %end% z %max% pro hledaný výraz '%query%':";
...
$text[3]['cz'] = "Nebyly nalezeny žádné výsledky pro výraz '%query%'";
...
$text[4]['cz'] = "Chybí vyhledávací rejstřík.";
...
$text[5]['cz'] = "Musíte zadat hledaný výraz.";

...
<body style="width:100%; height:100%; margin:0; padding:0;" onload="adjust_height();" onresize="adjust_height();">
  ...
  <iframe id="mainFrame" name="mainFrame" src="empty.php?site=<?php echo $site; ?>" style="position:fixed; top:100px; left:0; width:100%; height:100%; border:0; margin:0; padding:0;"></iframe>
</body>
</html>
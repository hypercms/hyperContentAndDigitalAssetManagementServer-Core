...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("button_width", 10);
	this.ensureDefault("button_height", 10);
	this.ensureDefault("button_text", "");
	this.ensureDefault("button_text_style", "font-family: Verdana, Arial, Helvetica; color: #FFFFFF; font-size: 9pt;");

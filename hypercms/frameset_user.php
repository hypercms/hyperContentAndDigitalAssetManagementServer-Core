...
<body class="hcmsTransBackground">
  ...
  <iframe id="controlFrame" name="controlFrame" src="control_user_menu.php?site=<?php echo url_encode ($site); ?>&group=*all*" frameborder="0" scrolling="no" style="position:fixed; top:0; left:0; width:100%; height:100px; border:0; margin:0; padding:0; overflow:hidden;"></iframe>
